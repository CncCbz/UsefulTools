    ...
    <div class="bg-deep-charcoal border-4 border-black rounded-xl p-4 shadow-hard">
      <div class="flex items-center justify-between mb-3">
        <div class="flex items-center gap-2">
          ...
          <span class="text-sm font-bold text-gray-400 uppercase tracking-wider">URL 编解码</span>
        </div>
      ...
      <textarea v-model="input" @input="convert" rows="5" :placeholder="mode === 'encode' ? '输入要编码的文本或 URL...' : '输入要解码的 URL 编码...'"
